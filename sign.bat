...
if "%~1"=="" (
    ...
    echo   sign.bat sign document.pdf signed_doc.pdf "selfsigned"
    ...
    echo   sign.bat sign document.pdf signed_doc.pdf "selfsigned" -o sign_log.txt
    echo   sign.bat sign document.pdf signed_doc.pdf "selfsigned" -o sign_log.txt --console
    echo   sign.bat batch "*.pdf" "signed" "selfsigned"
    echo   sign.bat batch "*.pdf" "output" "John Doe" "Batch signed" "Office" "-approved"
    echo   sign.bat batch "documents\*.pdf" "output" "John Doe" "Batch signed" "Office" "-approved"
    echo   sign.bat batch "*.pdf" "signed" "selfsigned" --output batch_log.txt
    echo   sign.bat batch "*.pdf" "signed" "selfsigned" -o results.txt -c
    ...
    echo   - Subject names: "selfsigned", "John Doe", "CN=John Doe, O=Company"
